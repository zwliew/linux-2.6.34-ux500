...
FILE        :  b2r2_strutures.h

DESCRIPTION :  Defines the structure representing various registers of B2R2 hardware.
...
extern volatile struct s_B2R2 * asicB2R2;
