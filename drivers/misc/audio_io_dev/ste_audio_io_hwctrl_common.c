...
const uint transducer_no_of_supported_loops[MAX_NO_TRANSDUCERS]=
	...
	0, 	//VibL		g3
	0, 	//VibR		g3
	0x02, 	//Mic1A		SideTone g2
	0x02, 	//Mic1A		SideTone g2
	0x02, 	//Mic2		SideTone g2
	0, 	//LinIn
	0,	//DMIC12	ANC
	0,	//DMIC34	ANC
	0,	//DMIC56
...
gain_descriptor_t gain_descriptor[MAX_NO_TRANSDUCERS][MAX_NO_CHANNELS][MAX_NO_GAINS]=
{
	//gainIndex=0	1			2
	//EDestinationEar
...
const int32 hs_analog_gain_table[16] = {4, 2, 0, -2, -4, -6, -8, -10,
