...
#ifndef U8500_V1
#define IRQ_CA_WAKE_REQ  		        (IRQ_SPI_START + 71)
#define IRQ_AC_READ_NOTIFICATION_0  		(IRQ_SPI_START + 66)
#define IRQ_AC_READ_NOTIFICATION_1  		(IRQ_SPI_START + 64)
#define IRQ_CA_MSG_PEND_NOTIFICATION_0  	(IRQ_SPI_START + 67)
#define IRQ_CA_MSG_PEND_NOTIFICATION_1  	(IRQ_SPI_START + 65)
#else
#define IRQ_CA_WAKE_REQ  			(IRQ_SPI_START + 83)
#define IRQ_AC_READ_NOTIFICATION_0  		(IRQ_SPI_START + 78)
#define IRQ_AC_READ_NOTIFICATION_1  		(IRQ_SPI_START + 76)
#define IRQ_CA_MSG_PEND_NOTIFICATION_0  	(IRQ_SPI_START + 79)
#define IRQ_CA_MSG_PEND_NOTIFICATION_1  	(IRQ_SPI_START + 77)
#endif
