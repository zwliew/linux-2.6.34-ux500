...
/**
  ...
  * @allocated:		Indicates wether this particular mailbox
...
struct mbox {
	...
	mbox_recv_cb_t *cb;
	void *client_data;
	u32 __iomem *virtbase_peer;
	u32 __iomem *virtbase_local;
...
/** mbox_setup - Set up a mailbox and return its instance.
  * @mbox_id:	The ID number of the mailbox. 0 or 1 for Acc, 2 for DSP.
...
/**
  ...
  * @block:	Specifies wether this call will block until send is possible,
