...
/********************************************************************************************/
PRIVATE t_ab8500_codec_error ab8500_codec_SingleWrite(t_uint8 register_offset, t_uint8 data)
{
    return(t_ab8500_codec_error) (AB8500_CODEC_Write(register_offset, 0x01, &data));
}
...
/********************************************************************************************/
PRIVATE t_ab8500_codec_error ab8500_codec_SingleRead(t_uint8 register_offset, t_uint8 data)
{
    t_uint8 dummy_data = 0xAA;

    return(t_ab8500_codec_error) (AB8500_CODEC_Read(register_offset, 0x01, &dummy_data, &data));
}
...
PRIVATE t_ab8500_codec_error ab8500_codec_UpdateCR11(void)
{
    ...
    (
        ...
        AB8500_CODEC_MASK_ONE_BIT,
        AB8500_CODEC_CR11_VIBLSHORTDIS
    );
    AB8500_CODEC_WRITE_BITS
    (
        value,
        ...
        AB8500_CODEC_MASK_ONE_BIT,
        AB8500_CODEC_CR11_VIBRSHORTDIS
    );
...
PRIVATE t_ab8500_codec_error ab8500_codec_UpdateCR51(void)
{
    ...
    (
        ...
        AB8500_CODEC_MASK_ONE_BIT,
        AB8500_CODEC_CR51_SLDAI1TOSLADO1
    );
    AB8500_CODEC_WRITE_BITS
    (
        value,
...
PRIVATE t_ab8500_codec_error ab8500_codec_UpdateCR52(void)
{
    ...
    (
        ...
        AB8500_CODEC_MASK_ONE_BIT,
        AB8500_CODEC_CR52_SLDAI1TOSLADO2
    );
    AB8500_CODEC_WRITE_BITS
    (
        value,
...
PRIVATE t_ab8500_codec_error ab8500_codec_UpdateCR53(void)
{
    ...
    (
        ...
        AB8500_CODEC_MASK_ONE_BIT,
        AB8500_CODEC_CR53_SLDAI1TOSLADO3
    );
    AB8500_CODEC_WRITE_BITS
    (
        value,
...
PRIVATE t_ab8500_codec_error ab8500_codec_UpdateCR55(void)
{
    ...
    (
        ...
        AB8500_CODEC_MASK_TWO_BITS,
        AB8500_CODEC_CR55_SLDAI1TOSLADO5
    );
    AB8500_CODEC_WRITE_BITS
    (
        value,
...
PRIVATE t_ab8500_codec_error ab8500_codec_UpdateCR56(void)
{
    ...
    (
        ...
        AB8500_CODEC_MASK_TWO_BITS,
        AB8500_CODEC_CR56_SLDAI1TOSLADO6
    );
    AB8500_CODEC_WRITE_BITS
    (
        value,
...
PRIVATE t_ab8500_codec_error ab8500_codec_UpdateCR59(void)
{
    ...
    (
        ...
        AB8500_CODEC_MASK_ONE_BIT,
        AB8500_CODEC_CR59_VSSREADY_MSK
    );
    AB8500_CODEC_WRITE_BITS
    (
        value,
        ...
        AB8500_CODEC_MASK_ONE_BIT,
        AB8500_CODEC_CR59_SHRTVIBL_MSK
    );
    AB8500_CODEC_WRITE_BITS
    (
        value,
        ...
        AB8500_CODEC_MASK_ONE_BIT,
        AB8500_CODEC_CR59_SHRTVIBR_MSK
    );
    AB8500_CODEC_WRITE_BITS
    (
        value,
...
PRIVATE t_ab8500_codec_error ab8500_codec_UpdateCR101(void)
{
    ...
    (
        ...
        AB8500_CODEC_MASK_ONE_BIT,
        AB8500_CODEC_CR101_CLASSDVIBLSWAPEN
    );
    AB8500_CODEC_WRITE_BITS
    (
        value,
        ...
        AB8500_CODEC_MASK_ONE_BIT,
        AB8500_CODEC_CR101_CLASSDVIBRSWAPEN
    );
    AB8500_CODEC_WRITE_BITS
    (
        value,
        ...
        AB8500_CODEC_MASK_ONE_BIT,
        AB8500_CODEC_CR101_CLASSDHFLSWAPEN
    );
    AB8500_CODEC_WRITE_BITS
    (
        value,
        ...
        AB8500_CODEC_MASK_ONE_BIT,
        AB8500_CODEC_CR101_CLASSDHFRSWAPEN
    );
...
PRIVATE t_ab8500_codec_error ab8500_codec_UpdateCR102(void)
{
    ...
    (
        ...
        AB8500_CODEC_MASK_FOUR_BITS,
        AB8500_CODEC_CR102_CLASSD_FIRBYP
    );
    AB8500_CODEC_WRITE_BITS
    (
        value,
        ...
        AB8500_CODEC_MASK_FOUR_BITS,
        AB8500_CODEC_CR102_CLASSD_HIGHVOLEN
    );
...
PRIVATE t_ab8500_codec_error ab8500_codec_UpdateCR107(void)
{
    ...
    (
        ...
        AB8500_CODEC_MASK_EIGHT_BITS,
        AB8500_CODEC_CR107_BFIFOSAMPNR
    );
...
PRIVATE t_ab8500_codec_error ab8500_codec_UpdateCR108(void)
{
    ...
    (
        ...
        AB8500_CODEC_MASK_EIGHT_BITS,
        AB8500_CODEC_CR108_BFIFOWAKEUP
    );
...
PRIVATE t_ab8500_codec_error ab8500_codec_Reset(void)
{
    ...
    p_ab8500_codec_configuration->cr1_swreset = AB8500_CODEC_CR1_SWRESET_ENABLED;
...
PRIVATE t_ab8500_codec_error ab8500_codec_ProgramDirection(IN t_ab8500_codec_direction ab8500_codec_direction)  /*only IN or OUT must be passed (not INOUT)*/
{
    t_ab8500_codec_error            ab8500_codec_error = AB8500_CODEC_OK;
...
PRIVATE t_ab8500_codec_error ab8500_codec_SetDirection(IN t_ab8500_codec_direction ab8500_codec_direction)
{
    t_ab8500_codec_error    ab8500_codec_error = AB8500_CODEC_OK;
    switch (ab8500_codec_direction)
    {
        case AB8500_CODEC_DIRECTION_IN:
            ab8500_codec_error = ab8500_codec_ProgramDirection(AB8500_CODEC_DIRECTION_IN);
            break;

        case AB8500_CODEC_DIRECTION_OUT:
            ab8500_codec_error = ab8500_codec_ProgramDirection(AB8500_CODEC_DIRECTION_OUT);
            break;
...
/****************************************************************************/
PUBLIC t_ab8500_codec_error AB8500_CODEC_Init(IN t_uint8 slave_address_of_ab8500_codec)
{
    DBGENTER1(" (%lx)", slave_address_of_ab8500_codec);

    g_ab8500_codec_system_context.slave_address_of_ab8500_codec = slave_address_of_ab8500_codec;
...
PUBLIC t_ab8500_codec_error AB8500_CODEC_Reset(void)
{
    ...
    g_ab8500_codec_system_context.ab8500_codec_direction = AB8500_CODEC_DEFAULT_DIRECTION;
    g_ab8500_codec_system_context.ab8500_codec_mode_in = AB8500_CODEC_DEFAULT_MODE_IN;
    g_ab8500_codec_system_context.ab8500_codec_mode_out = AB8500_CODEC_DEFAULT_MODE_OUT;

    g_ab8500_codec_system_context.ab8500_codec_src = AB8500_CODEC_DEFAULT_INPUT_SRC;
    g_ab8500_codec_system_context.ab8500_codec_dest = AB8500_CODEC_DEFAULT_OUTPUT_DEST;

    g_ab8500_codec_system_context.in_left_volume = AB8500_CODEC_DEFAULT_VOLUME_LEFT_IN;
    g_ab8500_codec_system_context.in_right_volume = AB8500_CODEC_DEFAULT_VOLUME_RIGHT_IN;
    g_ab8500_codec_system_context.out_left_volume = AB8500_CODEC_DEFAULT_VOLUME_LEFT_OUT;
...
)
{
    ...
    DBGENTER3(" (%lx %lx %lx)", ab8500_codec_direction, ab8500_codec_mode_in, ab8500_codec_mode_out);


    if (AB8500_CODEC_AUDIO_INTERFACE_1 == g_ab8500_codec_system_context.audio_interface)
    {
        if
        (
            AB8500_CODEC_DIRECTION_OUT == ab8500_codec_direction
        ||  AB8500_CODEC_DIRECTION_INOUT == ab8500_codec_direction
        )
        {
            p_ab8500_codec_configuration->cr3_enda1 = AB8500_CODEC_CR3_ENDA1_ENABLED;
            p_ab8500_codec_configuration->cr3_enda2 = AB8500_CODEC_CR3_ENDA2_ENABLED;
            p_ab8500_codec_configuration->cr3_enda3 = AB8500_CODEC_CR3_ENDA3_ENABLED;
            p_ab8500_codec_configuration->cr3_enda4 = AB8500_CODEC_CR3_ENDA4_ENABLED;
            p_ab8500_codec_configuration->cr3_enda5 = AB8500_CODEC_CR3_ENDA5_ENABLED;
            p_ab8500_codec_configuration->cr3_enda6 = AB8500_CODEC_CR3_ENDA6_ENABLED;

            if (AB8500_CODEC_MODE_HIFI == ab8500_codec_mode_out)
            {
                p_ab8500_codec_configuration->cr30_fsync1p = AB8500_CODEC_CR30_FSYNC1P_FALLING_EDGE;
                p_ab8500_codec_configuration->cr30_bitclk1p = AB8500_CODEC_CR30_BITCLK1P_FALLING_EDGE;
                p_ab8500_codec_configuration->cr30_if1del = AB8500_CODEC_CR30_IF1DEL_DELAYED;
                p_ab8500_codec_configuration->cr30_if1format = AB8500_CODEC_CR30_IF1FORMAT_I2S_LEFTALIGNED;
                p_ab8500_codec_configuration->cr30_if1wl = AB8500_CODEC_CR30_IF1WL_32BITS;
            }
            else
            {
                p_ab8500_codec_configuration->cr30_fsync1p = AB8500_CODEC_CR30_FSYNC1P_FALLING_EDGE;
                p_ab8500_codec_configuration->cr30_bitclk1p = AB8500_CODEC_CR30_BITCLK1P_FALLING_EDGE;
                p_ab8500_codec_configuration->cr30_if1del = AB8500_CODEC_CR30_IF1DEL_DELAYED;
                p_ab8500_codec_configuration->cr30_if1format = AB8500_CODEC_CR30_IF1FORMAT_TDM;
                p_ab8500_codec_configuration->cr30_if1wl = AB8500_CODEC_CR30_IF1WL_16BITS;
            }
        }

        if
        (
            AB8500_CODEC_DIRECTION_IN == ab8500_codec_direction
        ||  AB8500_CODEC_DIRECTION_INOUT == ab8500_codec_direction
        )
        {
            p_ab8500_codec_configuration->cr2_enad1 = AB8500_CODEC_CR2_ENAD1_ENABLED;
            p_ab8500_codec_configuration->cr2_enad2 = AB8500_CODEC_CR2_ENAD2_ENABLED;
            p_ab8500_codec_configuration->cr2_enad3 = AB8500_CODEC_CR2_ENAD3_ENABLED;
            p_ab8500_codec_configuration->cr2_enad4 = AB8500_CODEC_CR2_ENAD4_ENABLED;
            p_ab8500_codec_configuration->cr2_enad5 = AB8500_CODEC_CR2_ENAD5_ENABLED;
            ...
            {
                p_ab8500_codec_configuration->cr30_fsync1p = AB8500_CODEC_CR30_FSYNC1P_RISING_EDGE;
                p_ab8500_codec_configuration->cr30_bitclk1p = AB8500_CODEC_CR30_BITCLK1P_FALLING_EDGE;
                p_ab8500_codec_configuration->cr30_if1del = AB8500_CODEC_CR30_IF1DEL_NOT_DELAYED;
                p_ab8500_codec_configuration->cr30_if1format = AB8500_CODEC_CR30_IF1FORMAT_TDM;
                p_ab8500_codec_configuration->cr30_if1wl = AB8500_CODEC_CR30_IF1WL_16BITS;
            }
        }
    ...
    else
    {
        ...
        )
        {
            ...
            p_ab8500_codec_configuration->cr63_datohslen = AB8500_CODEC_CR63_DATOHSLEN_ENABLED;
            p_ab8500_codec_configuration->cr63_datohsren = AB8500_CODEC_CR63_DATOHSREN_ENABLED;

            if (AB8500_CODEC_MODE_HIFI == ab8500_codec_mode_out)
            {
		p_ab8500_codec_configuration->cr28_fsync0p = AB8500_CODEC_CR28_FSYNC0P_FALLING_EDGE;
                p_ab8500_codec_configuration->cr28_bitclk0p = AB8500_CODEC_CR28_BITCLK0P_FALLING_EDGE;
                p_ab8500_codec_configuration->cr28_if0del = AB8500_CODEC_CR28_IF0DEL_DELAYED;
                p_ab8500_codec_configuration->cr28_if0format = AB8500_CODEC_CR28_IF0FORMAT_I2S_LEFTALIGNED;
                p_ab8500_codec_configuration->cr28_if0wl = AB8500_CODEC_CR28_IF0WL_16BITS;
            }
            else
            {
                p_ab8500_codec_configuration->cr28_fsync0p = AB8500_CODEC_CR28_FSYNC0P_FALLING_EDGE;
                p_ab8500_codec_configuration->cr28_bitclk0p = AB8500_CODEC_CR28_BITCLK0P_FALLING_EDGE;
                p_ab8500_codec_configuration->cr28_if0del = AB8500_CODEC_CR28_IF0DEL_DELAYED;
                p_ab8500_codec_configuration->cr28_if0format = AB8500_CODEC_CR28_IF0FORMAT_TDM;
                p_ab8500_codec_configuration->cr28_if0wl = AB8500_CODEC_CR28_IF0WL_16BITS;
            }
        }
        ...
        )
        {
            ...
            p_ab8500_codec_configuration->cr26_ad1_voice = AB8500_CODEC_CR26_AD1_VOICE_LOWLATENCYFILTER;
            p_ab8500_codec_configuration->cr26_ad2_voice = AB8500_CODEC_CR26_AD2_VOICE_LOWLATENCYFILTER;
            p_ab8500_codec_configuration->cr26_ad3_voice = AB8500_CODEC_CR26_AD3_VOICE_LOWLATENCYFILTER;
            p_ab8500_codec_configuration->cr26_ad4_voice = AB8500_CODEC_CR26_AD4_VOICE_LOWLATENCYFILTER;

            if (AB8500_CODEC_MODE_HIFI == ab8500_codec_mode_in)
            {
                p_ab8500_codec_configuration->cr28_fsync0p = AB8500_CODEC_CR28_FSYNC0P_RISING_EDGE;
                p_ab8500_codec_configuration->cr28_bitclk0p = AB8500_CODEC_CR28_BITCLK0P_RISING_EDGE;
                p_ab8500_codec_configuration->cr28_if0del = AB8500_CODEC_CR28_IF0DEL_NOT_DELAYED;
                p_ab8500_codec_configuration->cr28_if0format = AB8500_CODEC_CR28_IF0FORMAT_I2S_LEFTALIGNED;
                p_ab8500_codec_configuration->cr28_if0wl = AB8500_CODEC_CR28_IF0WL_16BITS;
            }
            else
    ...
    g_ab8500_codec_system_context.ab8500_codec_direction = ab8500_codec_direction;
    g_ab8500_codec_system_context.ab8500_codec_mode_in = ab8500_codec_mode_in;
...
)
{
    ...
    t_ab8500_codec_configuration    *p_ab8500_codec_configuration = &g_ab8500_codec_system_context.
        ab8500_codec_configuration;
    DBGENTER3(" (%lx %lx %lx)", src_device, in_left_volume, in_right_volume);
    ...
    p_ab8500_codec_configuration->cr65_ad1gain = AB8500_CODEC_AD_D_VOLUME_MIN + (in_left_volume * (AB8500_CODEC_AD_D_VOLUME_MAX - AB8500_CODEC_AD_D_VOLUME_MIN)) / 100;
    p_ab8500_codec_configuration->cr66_ad2gain = AB8500_CODEC_AD_D_VOLUME_MIN + (in_left_volume * (AB8500_CODEC_AD_D_VOLUME_MAX - AB8500_CODEC_AD_D_VOLUME_MIN)) / 100;
    p_ab8500_codec_configuration->cr67_ad3gain = AB8500_CODEC_AD_D_VOLUME_MIN + (in_left_volume * (AB8500_CODEC_AD_D_VOLUME_MAX - AB8500_CODEC_AD_D_VOLUME_MIN)) / 100;
    p_ab8500_codec_configuration->cr68_ad4gain = AB8500_CODEC_AD_D_VOLUME_MIN + (in_left_volume * (AB8500_CODEC_AD_D_VOLUME_MAX - AB8500_CODEC_AD_D_VOLUME_MIN)) / 100;
    p_ab8500_codec_configuration->cr69_ad5gain = AB8500_CODEC_AD_D_VOLUME_MIN + (in_left_volume * (AB8500_CODEC_AD_D_VOLUME_MAX - AB8500_CODEC_AD_D_VOLUME_MIN)) / 100;
    p_ab8500_codec_configuration->cr70_ad6gain = AB8500_CODEC_AD_D_VOLUME_MIN + (in_left_volume * (AB8500_CODEC_AD_D_VOLUME_MAX - AB8500_CODEC_AD_D_VOLUME_MIN)) / 100;
    ...
    switch (src_device)
    {
        case AB8500_CODEC_SRC_LINEIN:
            p_ab8500_codec_configuration->cr22_linl_gain = AB8500_CODEC_LINEIN_VOLUME_MIN + (in_left_volume * (AB8500_CODEC_LINEIN_VOLUME_MAX - AB8500_CODEC_LINEIN_VOLUME_MIN)) / 100;
            p_ab8500_codec_configuration->cr23_linr_gain = AB8500_CODEC_LINEIN_VOLUME_MIN + (in_right_volume * (AB8500_CODEC_LINEIN_VOLUME_MAX - AB8500_CODEC_LINEIN_VOLUME_MIN)) / 100;
            break;

        case AB8500_CODEC_SRC_MICROPHONE_1A:
        case AB8500_CODEC_SRC_MICROPHONE_1B:
            p_ab8500_codec_configuration->cr20_mic1_gain = AB8500_CODEC_MIC_VOLUME_MIN + (in_left_volume * (AB8500_CODEC_MIC_VOLUME_MAX - AB8500_CODEC_MIC_VOLUME_MIN)) / 100;
            break;

        case AB8500_CODEC_SRC_MICROPHONE_2:
            p_ab8500_codec_configuration->cr21_mic2_gain = AB8500_CODEC_MIC_VOLUME_MIN + (in_left_volume * (AB8500_CODEC_MIC_VOLUME_MAX - AB8500_CODEC_MIC_VOLUME_MIN)) / 100;
            break;
...
)
{
    ...
    t_ab8500_codec_configuration    *p_ab8500_codec_configuration = &g_ab8500_codec_system_context.
        ab8500_codec_configuration;
    DBGENTER3(" (%lx %lx %lx)", dest_device, out_left_volume, out_right_volume);
    ...
    p_ab8500_codec_configuration->cr71_da1gain = AB8500_CODEC_DA_D_VOLUME_MIN + (out_left_volume * (AB8500_CODEC_DA_D_VOLUME_MAX - AB8500_CODEC_DA_D_VOLUME_MIN)) / 100;
    p_ab8500_codec_configuration->cr72_da2gain = AB8500_CODEC_DA_D_VOLUME_MIN + (out_left_volume * (AB8500_CODEC_DA_D_VOLUME_MAX - AB8500_CODEC_DA_D_VOLUME_MIN)) / 100;
    p_ab8500_codec_configuration->cr73_da3gain = AB8500_CODEC_DA_D_VOLUME_MIN + (out_left_volume * (AB8500_CODEC_DA_D_VOLUME_MAX - AB8500_CODEC_DA_D_VOLUME_MIN)) / 100;
    p_ab8500_codec_configuration->cr74_da4gain = AB8500_CODEC_DA_D_VOLUME_MIN + (out_left_volume * (AB8500_CODEC_DA_D_VOLUME_MAX - AB8500_CODEC_DA_D_VOLUME_MIN)) / 100;
    p_ab8500_codec_configuration->cr75_da5gain = AB8500_CODEC_DA_D_VOLUME_MIN + (out_left_volume * (AB8500_CODEC_DA_D_VOLUME_MAX - AB8500_CODEC_DA_D_VOLUME_MIN)) / 100;
    p_ab8500_codec_configuration->cr76_da6gain = AB8500_CODEC_DA_D_VOLUME_MIN + (out_left_volume * (AB8500_CODEC_DA_D_VOLUME_MAX - AB8500_CODEC_DA_D_VOLUME_MIN)) / 100;
    ...
    switch (dest_device)
    {
        case AB8500_CODEC_DEST_HEADSET:
            p_ab8500_codec_configuration->cr22_hsl_gain = AB8500_CODEC_HEADSET_VOLUME_MIN + (out_left_volume * (AB8500_CODEC_HEADSET_VOLUME_MAX - AB8500_CODEC_HEADSET_VOLUME_MIN)) / 100;
            p_ab8500_codec_configuration->cr23_hsr_gain = AB8500_CODEC_HEADSET_VOLUME_MIN + (out_right_volume * (AB8500_CODEC_HEADSET_VOLUME_MAX - AB8500_CODEC_HEADSET_VOLUME_MIN)) / 100;

            p_ab8500_codec_configuration->cr79_hsldgain = AB8500_CODEC_EARPIECE_D_VOLUME_MIN + (out_left_volume * (AB8500_CODEC_EARPIECE_D_VOLUME_MAX - AB8500_CODEC_EARPIECE_D_VOLUME_MIN)) / 100;
            p_ab8500_codec_configuration->cr80_hsrdgain = AB8500_CODEC_EARPIECE_D_VOLUME_MIN + (out_left_volume * (AB8500_CODEC_EARPIECE_D_VOLUME_MAX - AB8500_CODEC_EARPIECE_D_VOLUME_MIN)) / 100;
            break;
        ...
        case AB8500_CODEC_DEST_HANDSFREE:
			...
			p_ab8500_codec_configuration->cr101_parlhf = AB8500_CODEC_CR101_PARLHF_INDEPENDENT;
			p_ab8500_codec_configuration->cr101_parlvib = AB8500_CODEC_CR101_PARLVIB_INDEPENDENT;
			p_ab8500_codec_configuration->cr101_classd_viblswapen = AB8500_CODEC_CR101_CLASSD_VIBLSWAPEN_DISABLED;
			p_ab8500_codec_configuration->cr101_classd_vibrswapen = AB8500_CODEC_CR101_CLASSD_VIBRSWAPEN_DISABLED;
			p_ab8500_codec_configuration->cr101_classd_hflswapen = AB8500_CODEC_CR101_CLASSD_HFLSWAPEN_DISABLED;
			p_ab8500_codec_configuration->cr101_classd_hfrswapen = AB8500_CODEC_CR101_CLASSD_HFRSWAPEN_DISABLED;

			p_ab8500_codec_configuration->cr102_classd_firbyp = AB8500_CODEC_CR102_CLASSD_FIRBYP_ALL_ENABLED;
			p_ab8500_codec_configuration->cr102_classd_highvolen = AB8500_CODEC_CR102_CLASSD_HIGHVOLEN_DISABLED;
        ...
        case AB8500_CODEC_DEST_VIBRATOR_L:
            p_ab8500_codec_configuration->cr16_pwmnldutycycle = AB8500_CODEC_VIBRATOR_VOLUME_MIN;
            p_ab8500_codec_configuration->cr17_pwmpldutycycle = AB8500_CODEC_VIBRATOR_VOLUME_MIN + (out_right_volume * (AB8500_CODEC_VIBRATOR_VOLUME_MAX - AB8500_CODEC_VIBRATOR_VOLUME_MIN)) / 100;
            break;

        case AB8500_CODEC_DEST_VIBRATOR_R:
            p_ab8500_codec_configuration->cr18_pwmnrdutycycle = AB8500_CODEC_VIBRATOR_VOLUME_MIN;
            p_ab8500_codec_configuration->cr19_pwmprdutycycle = AB8500_CODEC_VIBRATOR_VOLUME_MIN + (out_right_volume * (AB8500_CODEC_VIBRATOR_VOLUME_MAX - AB8500_CODEC_VIBRATOR_VOLUME_MIN)) / 100;
            break;
...
/****************************************************************************/
PUBLIC t_ab8500_codec_error AB8500_CODEC_SetMasterMode(IN t_ab8500_codec_master_mode mode)
{
    t_ab8500_codec_configuration    *p_ab8500_codec_configuration = &g_ab8500_codec_system_context.
        ab8500_codec_configuration;
    t_ab8500_codec_error            ab8500_codec_error = AB8500_CODEC_OK;
    ...
    if (AB8500_CODEC_AUDIO_INTERFACE_1 == g_ab8500_codec_system_context.audio_interface)
    {
        ...
        p_ab8500_codec_configuration->cr27_en_mastgen = AB8500_CODEC_CR27_EN_MASTGEN_ENABLED;
        p_ab8500_codec_configuration->cr27_enfs_bitclk1 = AB8500_CODEC_CR27_ENFS_BITCLK1_ENABLED;

        if (AB8500_CODEC_MASTER_MODE_ENABLE == mode)
        {
            p_ab8500_codec_configuration->cr29_if1master = AB8500_CODEC_CR29_IF1MASTER_FS1CK1_OUTPUT;
        }
        else
        {
            p_ab8500_codec_configuration->cr29_if1master = AB8500_CODEC_CR29_IF1MASTER_FS1CK1_INPUT;
        }
        ...
        p_ab8500_codec_configuration->cr27_en_mastgen = AB8500_CODEC_CR27_EN_MASTGEN_ENABLED;
        p_ab8500_codec_configuration->cr27_enfs_bitclk0 = AB8500_CODEC_CR27_ENFS_BITCLK0_ENABLED;

        if (AB8500_CODEC_MASTER_MODE_ENABLE == mode)
        {
            p_ab8500_codec_configuration->cr29_if0master = AB8500_CODEC_CR29_IF0MASTER_FS0CK0_OUTPUT;
        }
        else
        {
            p_ab8500_codec_configuration->cr29_if0master = AB8500_CODEC_CR29_IF0MASTER_FS0CK0_INPUT;
        }
...
/****************************************************************************/
PUBLIC t_ab8500_codec_error AB8500_CODEC_SelectInput(IN t_ab8500_codec_src ab8500_codec_src)
{
    t_ab8500_codec_error    ab8500_codec_error = AB8500_CODEC_OK;
    ...
    ab8500_codec_error = ab8500_codec_SetDirection(AB8500_CODEC_DIRECTION_IN);
...
/****************************************************************************/
PUBLIC t_ab8500_codec_error AB8500_CODEC_SelectOutput(IN t_ab8500_codec_dest ab8500_codec_dest)
{
    t_ab8500_codec_error    ab8500_codec_error = AB8500_CODEC_OK;
    g_ab8500_codec_system_context.ab8500_codec_dest = ab8500_codec_dest;
    DBGENTER1(" (%lx)", ab8500_codec_dest);

    ab8500_codec_error = ab8500_codec_SetDirection(AB8500_CODEC_DIRECTION_OUT);
...
PUBLIC t_ab8500_codec_error AB8500_CODEC_PowerDown(void)
{
    ...
    g_ab8500_codec_system_context.ab8500_codec_configuration.cr0_powerup = AB8500_CODEC_CR0_POWERUP_OFF;
...
PUBLIC t_ab8500_codec_error AB8500_CODEC_PowerUp(void)
{
    ...
    g_ab8500_codec_system_context.ab8500_codec_configuration.cr0_powerup = AB8500_CODEC_CR0_POWERUP_ON;
    g_ab8500_codec_system_context.ab8500_codec_configuration.cr0_enaana = AB8500_CODEC_CR0_ENAANA_ON;
...
/****************************************************************************/
PUBLIC t_ab8500_codec_error AB8500_CODEC_SelectInterface(IN t_ab8500_codec_audio_interface audio_interface)
{
    t_ab8500_codec_error    ab8500_codec_error = AB8500_CODEC_OK;
    DBGENTER0();
...
/****************************************************************************/
PUBLIC t_ab8500_codec_error AB8500_CODEC_GetInterface(OUT t_ab8500_codec_audio_interface *p_audio_interface)
{
    t_ab8500_codec_error    ab8500_codec_error = AB8500_CODEC_OK;
    DBGENTER0();
...
/****************************************************************************/
PUBLIC t_ab8500_codec_error AB8500_CODEC_SetAnalogLoopback(IN t_uint8 out_left_volume, IN t_uint8 out_right_volume)
{
	t_ab8500_codec_error            ab8500_codec_error;
    t_ab8500_codec_configuration    *p_ab8500_codec_configuration = &g_ab8500_codec_system_context.ab8500_codec_configuration;
    ...
    p_ab8500_codec_configuration->cr24_lintohsl_gain = AB8500_CODEC_LINEIN_TO_HS_L_R_VOLUME_MIN + (out_left_volume * (AB8500_CODEC_LINEIN_TO_HS_L_R_VOLUME_MAX - AB8500_CODEC_LINEIN_TO_HS_L_R_VOLUME_MIN)) / 100;
    p_ab8500_codec_configuration->cr25_lintohsr_gain = AB8500_CODEC_LINEIN_TO_HS_L_R_VOLUME_MIN + (out_right_volume * (AB8500_CODEC_LINEIN_TO_HS_L_R_VOLUME_MAX - AB8500_CODEC_LINEIN_TO_HS_L_R_VOLUME_MIN)) / 100;
...
PUBLIC t_ab8500_codec_error AB8500_CODEC_RemoveAnalogLoopback(void)
{
    ...
    p_ab8500_codec_configuration->cr24_lintohsl_gain = AB8500_CODEC_LINEIN_TO_HS_L_R_LOOP_OPEN;
    p_ab8500_codec_configuration->cr25_lintohsr_gain = AB8500_CODEC_LINEIN_TO_HS_L_R_LOOP_OPEN;
...
PUBLIC t_ab8500_codec_error AB8500_CODEC_EnableBypassMode(void)
{
    ...
    if (AB8500_CODEC_AUDIO_INTERFACE_1 == g_ab8500_codec_system_context.audio_interface)
    {
	p_ab8500_codec_configuration->cr29_if1datoif0ad = AB8500_CODEC_CR29_IF1DATOIF0AD_SENT;
        p_ab8500_codec_configuration->cr29_if1cktoif0ck = AB8500_CODEC_CR29_IF1CKTOIF0CK_SENT;
    }
    else
    {
	p_ab8500_codec_configuration->cr29_if0datoif1ad = AB8500_CODEC_CR29_IF0DATOIF1AD_SENT;
        p_ab8500_codec_configuration->cr29_if0cktoif1ck = AB8500_CODEC_CR29_IF0CKTOIF1CK_SENT;
    }
...
PUBLIC t_ab8500_codec_error AB8500_CODEC_DisableBypassMode(void)
{
    ...
    if (AB8500_CODEC_AUDIO_INTERFACE_1 == g_ab8500_codec_system_context.audio_interface)
    {
	p_ab8500_codec_configuration->cr29_if1datoif0ad = AB8500_CODEC_CR29_IF1DATOIF0AD_NOTSENT;
        p_ab8500_codec_configuration->cr29_if1cktoif0ck = AB8500_CODEC_CR29_IF1CKTOIF0CK_NOTSENT;
    }
    else
    {
	p_ab8500_codec_configuration->cr29_if0datoif1ad = AB8500_CODEC_CR29_IF0DATOIF1AD_NOTSENT;
        p_ab8500_codec_configuration->cr29_if0cktoif1ck = AB8500_CODEC_CR29_IF0CKTOIF1CK_NOTSENT;
    }
...
/****************************************************************************/
PUBLIC t_ab8500_codec_error AB8500_CODEC_SrcPowerControl(IN t_ab8500_codec_src src_device, t_ab8500_codec_src_state state)
{
	t_ab8500_codec_error            ab8500_codec_error;
    ...
    {
	ab8500_codec_error = ab8500_codec_SrcPowerControlSwitch1(src_device, state);
        if (ab8500_codec_error != AB8500_CODEC_OK)
		{
            DBGEXIT(ab8500_codec_error);
            return(ab8500_codec_error);
		...
		{
	ab8500_codec_error = ab8500_codec_SrcPowerControlSwitch2(src_device, state);
        if (ab8500_codec_error != AB8500_CODEC_OK)
		{
            DBGEXIT(ab8500_codec_error);
            return(ab8500_codec_error);
...
/****************************************************************************/
PUBLIC t_ab8500_codec_error AB8500_CODEC_DestPowerControl(IN t_ab8500_codec_dest dest_device, t_ab8500_codec_dest_state state)
{
	t_ab8500_codec_error            ab8500_codec_error;
    t_ab8500_codec_configuration    *p_ab8500_codec_configuration = &g_ab8500_codec_system_context.ab8500_codec_configuration;
    ...
    switch (dest_device)
    {
		...
		{
                p_ab8500_codec_configuration->cr8_enhsl = AB8500_CODEC_CR8_ENHSL_ENABLED;
                p_ab8500_codec_configuration->cr8_enhsr = AB8500_CODEC_CR8_ENHSR_ENABLED;
                p_ab8500_codec_configuration->cr10_mutehsl = AB8500_CODEC_CR10_MUTEHSL_DISABLED;
                p_ab8500_codec_configuration->cr10_mutehsr = AB8500_CODEC_CR10_MUTEHSR_DISABLED;
		}
		else
		{
			p_ab8500_codec_configuration->cr8_enhsl = AB8500_CODEC_CR8_ENHSL_DISABLED;
                p_ab8500_codec_configuration->cr8_enhsr = AB8500_CODEC_CR8_ENHSR_DISABLED;
                p_ab8500_codec_configuration->cr10_mutehsl = AB8500_CODEC_CR10_MUTEHSL_ENABLED;
                p_ab8500_codec_configuration->cr10_mutehsr = AB8500_CODEC_CR10_MUTEHSR_ENABLED;
		}
		break;
        ...
        case AB8500_CODEC_DEST_EARPIECE:
            ...
            if(AB8500_CODEC_DEST_STATE_ENABLE == state)
		{
                p_ab8500_codec_configuration->cr8_enear = AB8500_CODEC_CR8_ENEAR_ENABLED;
                p_ab8500_codec_configuration->cr9_endacear = AB8500_CODEC_CR9_ENDACEAR_ENABLED;
                p_ab8500_codec_configuration->cr10_muteear = AB8500_CODEC_CR10_MUTEEAR_DISABLED;
		}
		else
		{
			p_ab8500_codec_configuration->cr8_enear = AB8500_CODEC_CR8_ENEAR_DISABLED;
			p_ab8500_codec_configuration->cr9_endacear = AB8500_CODEC_CR9_ENDACEAR_DISABLED;
                p_ab8500_codec_configuration->cr10_muteear = AB8500_CODEC_CR10_MUTEEAR_ENABLED;
		}
            break;
        ...
        case AB8500_CODEC_DEST_HANDSFREE:
            ...
            if(AB8500_CODEC_DEST_STATE_ENABLE == state)
		{
                p_ab8500_codec_configuration->cr8_enhfl = AB8500_CODEC_CR8_ENHFL_ENABLED;
                p_ab8500_codec_configuration->cr8_enhfr = AB8500_CODEC_CR8_ENHFR_ENABLED;
                p_ab8500_codec_configuration->cr9_endachfl = AB8500_CODEC_CR9_ENDACHFL_ENABLED;
				p_ab8500_codec_configuration->cr9_endachfr = AB8500_CODEC_CR9_ENDACHFR_ENABLED;
                p_ab8500_codec_configuration->cr10_mutehfl = AB8500_CODEC_CR10_MUTEHFL_DISABLED;
                p_ab8500_codec_configuration->cr10_mutehfr = AB8500_CODEC_CR10_MUTEHFR_DISABLED;
		}
		else
		{
			p_ab8500_codec_configuration->cr8_enhfl = AB8500_CODEC_CR8_ENHFL_DISABLED;
                p_ab8500_codec_configuration->cr8_enhfr = AB8500_CODEC_CR8_ENHFR_DISABLED;
                p_ab8500_codec_configuration->cr9_endachfl = AB8500_CODEC_CR9_ENDACHFL_DISABLED;
				p_ab8500_codec_configuration->cr9_endachfr = AB8500_CODEC_CR9_ENDACHFR_DISABLED;
                p_ab8500_codec_configuration->cr10_mutehfl = AB8500_CODEC_CR10_MUTEHFL_ENABLED;
                p_ab8500_codec_configuration->cr10_mutehfr = AB8500_CODEC_CR10_MUTEHFR_ENABLED;
		}
            break;
		...
		if(AB8500_CODEC_DEST_STATE_ENABLE == state)
		{
                p_ab8500_codec_configuration->cr8_envibl = AB8500_CODEC_CR8_ENVIBL_ENABLED;
				p_ab8500_codec_configuration->cr9_endacvibl = AB8500_CODEC_CR9_ENDACVIBL_ENABLED;
                p_ab8500_codec_configuration->cr10_mutevibl = AB8500_CODEC_CR10_MUTEVIBL_DISABLED;
                p_ab8500_codec_configuration->cr15_pwmtovibl = AB8500_CODEC_CR15_PWMTOVIBL_PWM;
                p_ab8500_codec_configuration->cr15_pwmlctrl = AB8500_CODEC_CR15_PWMLCTRL_PWMNPLDUTYCYCLE;
                p_ab8500_codec_configuration->cr15_pwmnlctrl = AB8500_CODEC_CR15_PWMNLCTRL_PWMNLDUTYCYCLE;
                p_ab8500_codec_configuration->cr15_pwmplctrl = AB8500_CODEC_CR15_PWMPLCTRL_PWMPLDUTYCYCLE;
		}
		else
		{
			p_ab8500_codec_configuration->cr8_envibl = AB8500_CODEC_CR8_ENVIBL_DISABLED;
				p_ab8500_codec_configuration->cr9_endacvibl = AB8500_CODEC_CR9_ENDACVIBL_DISABLED;
                p_ab8500_codec_configuration->cr10_mutevibl = AB8500_CODEC_CR10_MUTEVIBL_ENABLED;
                p_ab8500_codec_configuration->cr15_pwmtovibl = AB8500_CODEC_CR15_PWMTOVIBL_DA_PATH;
                p_ab8500_codec_configuration->cr15_pwmlctrl = AB8500_CODEC_CR15_PWMLCTRL_PWMNPLGPOL;
                p_ab8500_codec_configuration->cr15_pwmnlctrl = AB8500_CODEC_CR15_PWMNLCTRL_PWMNLGPOL;
                p_ab8500_codec_configuration->cr15_pwmplctrl = AB8500_CODEC_CR15_PWMPLCTRL_PWMPLGPOL;
		}
            break;
		...
		if(AB8500_CODEC_DEST_STATE_ENABLE == state)
		{
                p_ab8500_codec_configuration->cr8_envibr = AB8500_CODEC_CR8_ENVIBR_ENABLED;
                ...
                p_ab8500_codec_configuration->cr15_pwmrctrl = AB8500_CODEC_CR15_PWMRCTRL_PWMNPRDUTYCYCLE;
                p_ab8500_codec_configuration->cr15_pwmnrctrl = AB8500_CODEC_CR15_PWMNRCTRL_PWMNRDUTYCYCLE;
                p_ab8500_codec_configuration->cr15_pwmprctrl = AB8500_CODEC_CR15_PWMPRCTRL_PWMPRDUTYCYCLE;
		}
		else
		{
			p_ab8500_codec_configuration->cr8_envibr = AB8500_CODEC_CR8_ENVIBR_DISABLED;
				p_ab8500_codec_configuration->cr9_endacvibr = AB8500_CODEC_CR9_ENDACVIBR_DISABLED;
                p_ab8500_codec_configuration->cr10_mutevibr = AB8500_CODEC_CR10_MUTEVIBR_ENABLED;
                p_ab8500_codec_configuration->cr15_pwmtovibr = AB8500_CODEC_CR15_PWMTOVIBR_DA_PATH;
                p_ab8500_codec_configuration->cr15_pwmrctrl = AB8500_CODEC_CR15_PWMRCTRL_PWMNPRGPOL;
                p_ab8500_codec_configuration->cr15_pwmnrctrl = AB8500_CODEC_CR15_PWMNRCTRL_PWMNRGPOL;
                p_ab8500_codec_configuration->cr15_pwmprctrl = AB8500_CODEC_CR15_PWMPRCTRL_PWMPRGPOL;
		}
            break;
...
)
{
    ...
    {
        ab8500_codec_error = ab8500_codec_ADSlotAllocationSwitch1(ad_slot, value);
        if (ab8500_codec_error != AB8500_CODEC_OK)
        {
            DBGEXIT(ab8500_codec_error);
            return(ab8500_codec_error);
    ...
    {
	ab8500_codec_error = ab8500_codec_ADSlotAllocationSwitch2(ad_slot, value);
        if (ab8500_codec_error != AB8500_CODEC_OK)
        {
            DBGEXIT(ab8500_codec_error);
            return(ab8500_codec_error);
    ...
    {
	ab8500_codec_error = ab8500_codec_ADSlotAllocationSwitch3(ad_slot, value);
        if (ab8500_codec_error != AB8500_CODEC_OK)
        {
            DBGEXIT(ab8500_codec_error);
            return(ab8500_codec_error);
    ...
    {
	ab8500_codec_error = ab8500_codec_ADSlotAllocationSwitch4(ad_slot, value);
        if (ab8500_codec_error != AB8500_CODEC_OK)
        {
            DBGEXIT(ab8500_codec_error);
            return(ab8500_codec_error);
...
)
{
    ...
    p_ab8500_codec_configuration->cr51_da12_voice = AB8500_CODEC_CR51_DA12_VOICE_LOWLATENCYFILTER;
    ...
    p_ab8500_codec_configuration->cr0_powerup = AB8500_CODEC_CR0_POWERUP_OFF;
...
t_ab8500_codec_error AB8500_CODEC_ConfigureBurstFifo(IN t_ab8500_codec_burst_fifo_config const *const p_burst_fifo_config)
{
    ...
    if (AB8500_CODEC_AUDIO_INTERFACE_0 == g_ab8500_codec_system_context.audio_interface)
    {
        if (AB8500_CODEC_CR27_EN_MASTGEN_ENABLED == p_ab8500_codec_configuration->cr27_en_mastgen)
        {
            p_ab8500_codec_configuration->cr104_bfifoint = p_burst_fifo_config->cr104_bfifoint;

            p_ab8500_codec_configuration->cr105_bfifotx = p_burst_fifo_config->cr105_bfifotx;

            p_ab8500_codec_configuration->cr106_bfifofsext = p_burst_fifo_config->cr106_bfifofsext;
            p_ab8500_codec_configuration->cr106_bfifomsk = p_burst_fifo_config->cr106_bfifomsk;
            p_ab8500_codec_configuration->cr106_bfifomstr = p_burst_fifo_config->cr106_bfifomstr;
            p_ab8500_codec_configuration->cr106_bfifostrt = p_burst_fifo_config->cr106_bfifostrt;

            p_ab8500_codec_configuration->cr107_bfifosampnr = p_burst_fifo_config->cr107_bfifosampnr;

            p_ab8500_codec_configuration->cr108_bfifowakeup = p_burst_fifo_config->cr108_bfifowakeup;
...
PUBLIC t_ab8500_codec_error AB8500_CODEC_EnableBurstFifo(void)
{
    ...
    if (AB8500_CODEC_AUDIO_INTERFACE_0 == g_ab8500_codec_system_context.audio_interface)
    {
        p_ab8500_codec_configuration->cr29_if0bfifoen = AB8500_CODEC_CR29_IF0BFIFOEN_BURST_MODE;
...
PUBLIC t_ab8500_codec_error AB8500_CODEC_DisableBurstFifo(void)
{
    ...
    if (AB8500_CODEC_AUDIO_INTERFACE_0 == g_ab8500_codec_system_context.audio_interface)
    {
        p_ab8500_codec_configuration->cr29_if0bfifoen = AB8500_CODEC_CR29_IF0BFIFOEN_NORMAL_MODE;
...
PRIVATE t_ab8500_codec_error ab8500_codec_SrcPowerControlSwitch1(IN t_ab8500_codec_src src_device, t_ab8500_codec_src_state state)
{
    ...
    switch (src_device)
    {
		...
		{
			p_ab8500_codec_configuration->cr5_enlinl = AB8500_CODEC_CR5_ENLINL_ENABLED;
                p_ab8500_codec_configuration->cr5_enlinr = AB8500_CODEC_CR5_ENLINR_ENABLED;
                p_ab8500_codec_configuration->cr5_mutlinl = AB8500_CODEC_CR5_MUTLINL_DISABLED;
                p_ab8500_codec_configuration->cr5_mutlinr = AB8500_CODEC_CR5_MUTLINR_DISABLED;

                p_ab8500_codec_configuration->cr7_linrsel = AB8500_CODEC_CR7_LINRSEL_LINR;
                p_ab8500_codec_configuration->cr7_enadclinl = AB8500_CODEC_CR7_ENADCLINL_ENABLED;
				p_ab8500_codec_configuration->cr7_enadclinr = AB8500_CODEC_CR7_ENADCLINR_ENABLED;
		}
		else
		{
			p_ab8500_codec_configuration->cr5_enlinl = AB8500_CODEC_CR5_ENLINL_DISABLED;
                p_ab8500_codec_configuration->cr5_enlinr = AB8500_CODEC_CR5_ENLINR_DISABLED;
                p_ab8500_codec_configuration->cr5_mutlinl = AB8500_CODEC_CR5_MUTLINL_ENABLED;
                p_ab8500_codec_configuration->cr5_mutlinr = AB8500_CODEC_CR5_MUTLINR_ENABLED;

                p_ab8500_codec_configuration->cr7_linrsel = AB8500_CODEC_CR7_LINRSEL_MIC2;
                p_ab8500_codec_configuration->cr7_enadclinl = AB8500_CODEC_CR7_ENADCLINL_DISABLED;
				p_ab8500_codec_configuration->cr7_enadclinr = AB8500_CODEC_CR7_ENADCLINR_DISABLED;
		}
            break;
        ...
        case AB8500_CODEC_SRC_MICROPHONE_1A:
            ...
            if(AB8500_CODEC_SRC_STATE_ENABLE == state)
		{
		    p_ab8500_codec_configuration->cr5_enmic1 = AB8500_CODEC_CR5_ENMIC1_ENABLED;
		    p_ab8500_codec_configuration->cr5_mutmic1 = AB8500_CODEC_CR5_MUTMIC1_DISABLED;

		    p_ab8500_codec_configuration->cr7_mic1sel = AB8500_CODEC_CR7_MIC1SEL_MIC1A;
                p_ab8500_codec_configuration->cr7_enadcmic = AB8500_CODEC_CR7_ENADCMIC_ENABLED;
		}
		else
		{
			p_ab8500_codec_configuration->cr5_enmic1 = AB8500_CODEC_CR5_ENMIC1_DISABLED;
            ...
            if(AB8500_CODEC_SRC_STATE_ENABLE == state)
		{
		    ...
		    p_ab8500_codec_configuration->cr7_mic1sel = AB8500_CODEC_CR7_MIC1SEL_MIC1B;
                p_ab8500_codec_configuration->cr7_enadcmic = AB8500_CODEC_CR7_ENADCMIC_ENABLED;
		}
		else
		{
        ...
        case AB8500_CODEC_SRC_MICROPHONE_2:
            ...
            if(AB8500_CODEC_SRC_STATE_ENABLE == state)
		{
		    p_ab8500_codec_configuration->cr5_enmic2 = AB8500_CODEC_CR5_ENMIC2_ENABLED;
		...
		{
			p_ab8500_codec_configuration->cr5_enmic2 = AB8500_CODEC_CR5_ENMIC2_DISABLED;
			p_ab8500_codec_configuration->cr5_mutmic2 = AB8500_CODEC_CR5_MUTMIC2_ENABLED;
		...
		if(AB8500_CODEC_SRC_STATE_ENABLE == state)
		{
		    p_ab8500_codec_configuration->cr6_endmic1 = AB8500_CODEC_CR6_ENDMIC1_ENABLED;

		    p_ab8500_codec_configuration->cr63_ad1sel = AB8500_CODEC_CR63_AD1SEL_DMIC1_SELECTED;
		}
		else
		{
			p_ab8500_codec_configuration->cr6_endmic1 = AB8500_CODEC_CR6_ENDMIC1_DISABLED;
		...
		if(AB8500_CODEC_SRC_STATE_ENABLE == state)
		{
                p_ab8500_codec_configuration->cr6_endmic2 = AB8500_CODEC_CR6_ENDMIC2_ENABLED;

                p_ab8500_codec_configuration->cr63_ad2sel = AB8500_CODEC_CR63_AD2SEL_DMIC2_SELECTED;
		}
		else
    {
                p_ab8500_codec_configuration->cr6_endmic2 = AB8500_CODEC_CR6_ENDMIC2_DISABLED;

                p_ab8500_codec_configuration->cr63_ad2sel = AB8500_CODEC_CR63_AD2SEL_LINRADR_SELECTED;
		}
            break;
...
PRIVATE t_ab8500_codec_error ab8500_codec_SrcPowerControlSwitch2(IN t_ab8500_codec_src src_device, t_ab8500_codec_src_state state)
{
    ...
    switch (src_device)
    {
		...
		if(AB8500_CODEC_SRC_STATE_ENABLE == state)
		{
		    p_ab8500_codec_configuration->cr6_endmic3 = AB8500_CODEC_CR6_ENDMIC3_ENABLED;

		    p_ab8500_codec_configuration->cr63_ad3sel = AB8500_CODEC_CR63_AD3SEL_DMIC3_SELECTED;
		}
		else
		{
			p_ab8500_codec_configuration->cr6_endmic3 = AB8500_CODEC_CR6_ENDMIC3_DISABLED;

			p_ab8500_codec_configuration->cr63_ad3sel = AB8500_CODEC_CR63_AD3SEL_ADMO_SELECTED;
		}
            break;
		...
		if(AB8500_CODEC_SRC_STATE_ENABLE == state)
		{
                p_ab8500_codec_configuration->cr6_endmic4 = AB8500_CODEC_CR6_ENDMIC4_ENABLED;
		}
		else
		{
                p_ab8500_codec_configuration->cr6_endmic4 = AB8500_CODEC_CR6_ENDMIC4_DISABLED;
		}
            break;
		...
		if(AB8500_CODEC_SRC_STATE_ENABLE == state)
		{
		    p_ab8500_codec_configuration->cr6_endmic5 = AB8500_CODEC_CR6_ENDMIC5_ENABLED;

		    p_ab8500_codec_configuration->cr63_ad5sel = AB8500_CODEC_CR63_AD5SEL_DMIC5_SELECTED;
		}
		else
		{
			p_ab8500_codec_configuration->cr6_endmic5 = AB8500_CODEC_CR6_ENDMIC5_DISABLED;

			p_ab8500_codec_configuration->cr63_ad5sel = AB8500_CODEC_CR63_AD5SEL_AMADR_SELECTED;
		}
            break;
		...
		if(AB8500_CODEC_SRC_STATE_ENABLE == state)
		{
                p_ab8500_codec_configuration->cr6_endmic6 = AB8500_CODEC_CR6_ENDMIC6_ENABLED;

                p_ab8500_codec_configuration->cr63_ad6sel = AB8500_CODEC_CR63_AD6SEL_DMIC6_SELECTED;
		}
		else
		{
                p_ab8500_codec_configuration->cr6_endmic6 = AB8500_CODEC_CR6_ENDMIC6_DISABLED;

                p_ab8500_codec_configuration->cr63_ad6sel = AB8500_CODEC_CR63_AD6SEL_ADMO_SELECTED;
		}
            break;
...
PRIVATE t_ab8500_codec_error ab8500_codec_ProgramDirectionOUT(void)
{
    ...
    {
            case AB8500_CODEC_DEST_HEADSET:
                p_ab8500_codec_configuration->cr7_endrvhsl = AB8500_CODEC_CR7_ENDRVHSL_ENABLED;
                p_ab8500_codec_configuration->cr7_endrvhsr = AB8500_CODEC_CR7_ENDRVHSR_ENABLED;
                ...
                p_ab8500_codec_configuration->cr9_endachsl = AB8500_CODEC_CR9_ENDACHSL_ENABLED;
                p_ab8500_codec_configuration->cr9_endachsr = AB8500_CODEC_CR9_ENDACHSR_ENABLED;
                ...
                p_ab8500_codec_configuration->cr12_encphs = AB8500_CODEC_CR12_ENCPHS_ENABLED;
